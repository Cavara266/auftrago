      ...
      >
        ...
        <div
          ...
          style={{
            display: "grid",
            gridTemplateColumns:
              "minmax(0,1.35fr) minmax(280px,.72fr)",
            gap: 16,
          }}
        >
          <section
            ...
            style={{
              ...
              background:
                "linear-gradient(145deg,rgba(8,19,37,.96),rgba(10,22,42,.90))",
              overflow: "hidden",
              position: "relative",
            }}
          >
          ...
          <section
            ...
            style={{
              ...
              background:
                "linear-gradient(145deg,rgba(13,22,42,.96),rgba(31,22,68,.90))",
            }}
          >
            <div style={eyebrow}>
              MONEY TO COLLECT
