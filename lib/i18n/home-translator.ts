...
const finalHomepageTranslations: Partial<
  Record<Locale, Record<string, string>>
> = {
  en: {
    "Sauberkeit auf höchstem Niveau": "Cleanliness at the highest level",
    "Profis für jedes Projekt": "Professionals for every project",
    "Sicher von A nach B": "Safe from A to B",
    "Alles rund ums Grundstück": "Everything around your property",
    "Betreuung mit System": "Professional property care",
    "Über 420 Möglichkeiten": "Over 420 possibilities",
    "Umzugsreinigung 3.5 Zimmer": "End-of-tenancy cleaning, 3.5 rooms",
    "Malerarbeiten Wohnung": "Apartment painting",
    "Privatumzug mit Möbelmontage": "Private move with furniture assembly",
    "Gartenpflege & Heckenschnitt": "Garden maintenance & hedge trimming",
    "Elektriker für Beleuchtung": "Electrician for lighting",
    "Hauswartung für Liegenschaft": "Property maintenance",
    "Innerhalb 2 Wochen": "Within 2 weeks",
    "Fixer Termin": "Fixed date",
    ...
    "Top Auftrag": "Top job",
    "Premium": "Premium",
    "Aktuelle Kundenanfrage": "Current customer request",
    "Freischaltung": "Unlock",
    "Anfrage ansehen": "View request",
    "Entdecke aktuelle Anfragen aus verschiedenen Regionen und Branchen. Registrierte Anbieter sehen nach der Freischaltung alle Details und Kontaktdaten.": "Discover current requests from different regions and industries. Registered providers can view all details and contact information after unlocking.",
    "✓ Regionale Anfragen": "✓ Regional requests",
    "✓ Neue Kategorien": "✓ New categories",
    "✓ Direkter Kontakt mit dem Kunden": "✓ Direct customer contact",
    "Für Schweizer Dienstleister": "For Swiss providers",
    "Registriere deinen Betrieb, wähle deine Regionen und Dienstleistungen und erhalte Zugang zu relevanten Kundenanfragen.": "Register your business, choose your regions and services, and get access to relevant customer requests.",
    "Aufträge aus deinen Regionen": "Jobs from your regions",
    "Nur passende Kategorien": "Only relevant categories",
    "Volle Kostenkontrolle": "Full cost control",
    "Keine klassische Kaltakquise": "No traditional cold calling",
    "Auftrago Anbieter-Netzwerk": "Auftrago provider network",
    "Jetzt Teil der Plattform werden": "Join the platform now",
    "Kunden suchen bereits.": "Customers are already searching.",
    "Sei dort, wenn es zählt.": "Be there when it matters.",
    "Kostenlos als Anbieter registrieren": "Register as a provider for free",
    "So funktioniert es": "How it works",
    "Die vollständige Beschreibung, Adresse, Datum und Kontaktdaten sind nach der Freischaltung sichtbar.": "The full description, address, date and contact details are visible after unlocking.",
  },

  it: {
    "Sauberkeit auf höchstem Niveau": "Pulizia ai massimi livelli",
    "Profis für jedes Projekt": "Professionisti per ogni progetto",
    "Sicher von A nach B": "Da A a B in sicurezza",
    "Alles rund ums Grundstück": "Tutto per giardino e spazi esterni",
    "Betreuung mit System": "Gestione professionale dell'immobile",
    "Über 420 Möglichkeiten": "Oltre 420 possibilità",
    "Umzugsreinigung 3.5 Zimmer": "Pulizia di fine locazione, 3.5 locali",
    "Malerarbeiten Wohnung": "Lavori di pittura nell'appartamento",
    "Privatumzug mit Möbelmontage": "Trasloco privato con montaggio mobili",
    "Gartenpflege & Heckenschnitt": "Cura del giardino e taglio siepi",
    "Elektriker für Beleuchtung": "Elettricista per illuminazione",
    "Hauswartung für Liegenschaft": "Custodia dell'immobile",
    "Innerhalb 2 Wochen": "Entro 2 settimane",
    "Fixer Termin": "Data fissa",
    ...
    "Aktuelle Kundenanfrage": "Richiesta attuale del cliente",
    "Freischaltung": "Sblocco",
    "Anfrage ansehen": "Visualizza richiesta",
    "Entdecke aktuelle Anfragen aus verschiedenen Regionen und Branchen. Registrierte Anbieter sehen nach der Freischaltung alle Details und Kontaktdaten.": "Scopri richieste attuali provenienti da diverse regioni e settori. Dopo lo sblocco, i fornitori registrati possono vedere tutti i dettagli e i dati di contatto.",
    "✓ Regionale Anfragen": "✓ Richieste regionali",
    "✓ Neue Kategorien": "✓ Nuove categorie",
    "✓ Direkter Kontakt mit dem Kunden": "✓ Contatto diretto con il cliente",
    "Für Schweizer Dienstleister": "Per fornitori svizzeri",
    "Registriere deinen Betrieb, wähle deine Regionen und Dienstleistungen und erhalte Zugang zu relevanten Kundenanfragen.": "Registra la tua attività, scegli le regioni e i servizi e accedi a richieste di clienti pertinenti.",
    "Aufträge aus deinen Regionen": "Incarichi dalle tue regioni",
    "Nur passende Kategorien": "Solo categorie pertinenti",
    "Volle Kostenkontrolle": "Pieno controllo dei costi",
    "Keine klassische Kaltakquise": "Nessuna acquisizione telefonica a freddo",
    "Auftrago Anbieter-Netzwerk": "Rete di fornitori Auftrago",
    "Jetzt Teil der Plattform werden": "Entra ora nella piattaforma",
    "Kunden suchen bereits.": "I clienti stanno già cercando.",
    "Sei dort, wenn es zählt.": "Fatti trovare quando conta.",
    "Kostenlos als Anbieter registrieren": "Registrati gratuitamente come fornitore",
    "So funktioniert es": "Come funziona",
    "Die vollständige Beschreibung, Adresse, Datum und Kontaktdaten sind nach der Freischaltung sichtbar.": "La descrizione completa, l'indirizzo, la data e i dati di contatto sono visibili dopo lo sblocco.",
  },

  fr: {
    "Sauberkeit auf höchstem Niveau": "Une propreté au plus haut niveau",
    "Profis für jedes Projekt": "Des professionnels pour chaque projet",
    "Sicher von A nach B": "De A à B en toute sécurité",
    "Alles rund ums Grundstück": "Tout pour votre jardin et vos extérieurs",
    "Betreuung mit System": "Gestion professionnelle de votre bien",
    "Über 420 Möglichkeiten": "Plus de 420 possibilités",
    "Umzugsreinigung 3.5 Zimmer": "Nettoyage de fin de bail, 3.5 pièces",
    "Malerarbeiten Wohnung": "Travaux de peinture dans l'appartement",
    "Privatumzug mit Möbelmontage": "Déménagement privé avec montage de meubles",
    "Gartenpflege & Heckenschnitt": "Entretien du jardin et taille de haies",
    "Elektriker für Beleuchtung": "Électricien pour éclairage",
    "Hauswartung für Liegenschaft": "Conciergerie d'immeuble",
    "Innerhalb 2 Wochen": "Sous 2 semaines",
    "Fixer Termin": "Date fixe",
    "Nächste Woche": "La semaine prochaine",
    "Schnellstmöglich": "Dès que possible",
    "Wiederkehrend": "Récurrent",
    "Aktiv": "Actif",
    "Dringend": "Urgent",
    "Top Auftrag": "Mission premium",
    "Aktuelle Kundenanfrage": "Demande actuelle du client",
    "Freischaltung": "Déblocage",
    "Anfrage ansehen": "Voir la demande",
    "✓ Regionale Anfragen": "✓ Demandes régionales",
    "✓ Neue Kategorien": "✓ Nouvelles catégories",
    "✓ Direkter Kontakt mit dem Kunden": "✓ Contact direct avec le client",
    "Für Schweizer Dienstleister": "Pour les prestataires suisses",
    "Aufträge aus deinen Regionen": "Missions de vos régions",
    "Nur passende Kategorien": "Uniquement les catégories pertinentes",
    "Volle Kostenkontrolle": "Contrôle total des coûts",
    "Keine klassische Kaltakquise": "Pas de démarchage téléphonique classique",
  },

  pt: {
    "Sauberkeit auf höchstem Niveau": "Limpeza ao mais alto nível",
    "Profis für jedes Projekt": "Profissionais para cada projeto",
    "Sicher von A nach B": "De A a B em segurança",
    "Alles rund ums Grundstück": "Tudo para jardim e áreas exteriores",
    "Betreuung mit System": "Gestão profissional do imóvel",
    "Über 420 Möglichkeiten": "Mais de 420 possibilidades",
    "Umzugsreinigung 3.5 Zimmer": "Limpeza de mudança, 3,5 divisões",
    "Malerarbeiten Wohnung": "Pintura de apartamento",
    "Privatumzug mit Möbelmontage": "Mudança privada com montagem de móveis",
    "Gartenpflege & Heckenschnitt": "Manutenção de jardim e corte de sebes",
    "Elektriker für Beleuchtung": "Eletricista para iluminação",
    "Hauswartung für Liegenschaft": "Manutenção de imóvel",
    "Innerhalb 2 Wochen": "Dentro de 2 semanas",
    "Fixer Termin": "Data fixa",
    "Nächste Woche": "Próxima semana",
    "Schnellstmöglich": "O mais rápido possível",
    "Wiederkehrend": "Recorrente",
    "Aktiv": "Ativo",
    "Dringend": "Urgente",
    "Top Auftrag": "Pedido em destaque",
    "Aktuelle Kundenanfrage": "Pedido atual do cliente",
    "Freischaltung": "Desbloqueio",
    "Anfrage ansehen": "Ver pedido",
    "✓ Regionale Anfragen": "✓ Pedidos regionais",
    "✓ Neue Kategorien": "✓ Novas categorias",
    "✓ Direkter Kontakt mit dem Kunden": "✓ Contacto direto com o cliente",
    "Für Schweizer Dienstleister": "Para prestadores suíços",
    "Aufträge aus deinen Regionen": "Pedidos das suas regiões",
    "Nur passende Kategorien": "Apenas categorias relevantes",
    "Volle Kostenkontrolle": "Controlo total dos custos",
    "Keine klassische Kaltakquise": "Sem chamadas comerciais a frio",
  },

  es: {
    "Sauberkeit auf höchstem Niveau": "Limpieza al más alto nivel",
    "Profis für jedes Projekt": "Profesionales para cada proyecto",
    "Sicher von A nach B": "De A a B con seguridad",
    "Alles rund ums Grundstück": "Todo para jardín y exteriores",
    "Betreuung mit System": "Gestión profesional del inmueble",
    "Über 420 Möglichkeiten": "Más de 420 posibilidades",
    "Umzugsreinigung 3.5 Zimmer": "Limpieza de mudanza, 3,5 habitaciones",
    "Malerarbeiten Wohnung": "Pintura de apartamento",
    "Privatumzug mit Möbelmontage": "Mudanza privada con montaje de muebles",
    "Gartenpflege & Heckenschnitt": "Mantenimiento de jardín y poda de setos",
    "Elektriker für Beleuchtung": "Electricista para iluminación",
    "Hauswartung für Liegenschaft": "Mantenimiento del inmueble",
    "Innerhalb 2 Wochen": "En 2 semanas",
    "Fixer Termin": "Fecha fija",
    "Nächste Woche": "La próxima semana",
    "Schnellstmöglich": "Lo antes posible",
    "Wiederkehrend": "Recurrente",
    "Aktiv": "Activo",
    "Dringend": "Urgente",
    "Top Auftrag": "Trabajo destacado",
    "Aktuelle Kundenanfrage": "Solicitud actual del cliente",
    "Freischaltung": "Desbloqueo",
    "Anfrage ansehen": "Ver solicitud",
    "✓ Regionale Anfragen": "✓ Solicitudes regionales",
    "✓ Neue Kategorien": "✓ Nuevas categorías",
    "✓ Direkter Kontakt mit dem Kunden": "✓ Contacto directo con el cliente",
    "Für Schweizer Dienstleister": "Para proveedores suizos",
    "Aufträge aus deinen Regionen": "Trabajos de tus regiones",
    "Nur passende Kategorien": "Solo categorías relevantes",
    "Volle Kostenkontrolle": "Control total de costes",
    "Keine klassische Kaltakquise": "Sin llamadas comerciales en frío",
  },

  tr: {
    "Sauberkeit auf höchstem Niveau": "En yüksek seviyede temizlik",
    "Profis für jedes Projekt": "Her proje için profesyoneller",
    "Sicher von A nach B": "A'dan B'ye güvenle",
    "Alles rund ums Grundstück": "Bahçe ve dış alanlar için her şey",
    "Betreuung mit System": "Profesyonel bina yönetimi",
    "Über 420 Möglichkeiten": "420'den fazla seçenek",
    "Umzugsreinigung 3.5 Zimmer": "3,5 odalı taşınma temizliği",
    "Malerarbeiten Wohnung": "Daire boya işleri",
    "Privatumzug mit Möbelmontage": "Mobilya montajlı özel taşınma",
    "Gartenpflege & Heckenschnitt": "Bahçe bakımı ve çit budama",
    "Elektriker für Beleuchtung": "Aydınlatma elektrikçisi",
    "Hauswartung für Liegenschaft": "Bina bakım hizmeti",
    "Innerhalb 2 Wochen": "2 hafta içinde",
    "Fixer Termin": "Sabit tarih",
    "Nächste Woche": "Gelecek hafta",
    "Schnellstmöglich": "En kısa sürede",
    "Wiederkehrend": "Düzenli",
    "Aktiv": "Aktif",
    "Dringend": "Acil",
    "Top Auftrag": "Öne çıkan iş",
    "Aktuelle Kundenanfrage": "Güncel müşteri talebi",
    "Freischaltung": "Kilidi aç",
    "Anfrage ansehen": "Talebi görüntüle",
    "✓ Regionale Anfragen": "✓ Bölgesel talepler",
    "✓ Neue Kategorien": "✓ Yeni kategoriler",
    "✓ Direkter Kontakt mit dem Kunden": "✓ Müşteriyle doğrudan iletişim",
    "Für Schweizer Dienstleister": "İsviçreli hizmet sağlayıcılar için",
    "Aufträge aus deinen Regionen": "Bölgelerinizden işler",
    "Nur passende Kategorien": "Yalnızca uygun kategoriler",
    "Volle Kostenkontrolle": "Tam maliyet kontrolü",
    "Keine klassische Kaltakquise": "Klasik soğuk arama yok",
  },

  sq: {
    "Sauberkeit auf höchstem Niveau": "Pastërti në nivelin më të lartë",
    "Profis für jedes Projekt": "Profesionistë për çdo projekt",
    "Sicher von A nach B": "Nga A në B në mënyrë të sigurt",
    "Alles rund ums Grundstück": "Gjithçka për kopshtin dhe ambientin e jashtëm",
    "Betreuung mit System": "Mirëmbajtje profesionale e pronës",
    "Über 420 Möglichkeiten": "Mbi 420 mundësi",
    "Umzugsreinigung 3.5 Zimmer": "Pastrim pas zhvendosjes, 3.5 dhoma",
    "Malerarbeiten Wohnung": "Lyerje apartamenti",
    "Privatumzug mit Möbelmontage": "Zhvendosje private me montim mobiljesh",
    "Gartenpflege & Heckenschnitt": "Mirëmbajtje kopshti dhe krasitje",
    "Elektriker für Beleuchtung": "Elektricist për ndriçim",
    "Hauswartung für Liegenschaft": "Mirëmbajtje prone",
    "Innerhalb 2 Wochen": "Brenda 2 javësh",
    "Fixer Termin": "Datë fikse",
    "Nächste Woche": "Javën e ardhshme",
    "Schnellstmöglich": "Sa më shpejt",
    "Wiederkehrend": "Periodike",
    "Aktiv": "Aktive",
    "Dringend": "Urgjente",
    "Top Auftrag": "Punë kryesore",
    "Aktuelle Kundenanfrage": "Kërkesa aktuale e klientit",
    "Freischaltung": "Zhbllokim",
    "Anfrage ansehen": "Shiko kërkesën",
    "✓ Regionale Anfragen": "✓ Kërkesa rajonale",
    "✓ Neue Kategorien": "✓ Kategori të reja",
    "✓ Direkter Kontakt mit dem Kunden": "✓ Kontakt direkt me klientin",
    "Für Schweizer Dienstleister": "Për ofruesit zviceranë",
    "Aufträge aus deinen Regionen": "Punë nga rajonet e tua",
    "Nur passende Kategorien": "Vetëm kategori të përshtatshme",
    "Volle Kostenkontrolle": "Kontroll i plotë i kostove",
    "Keine klassische Kaltakquise": "Pa telefonata të ftohta klasike",
  },
};


const providerAdvantageTranslations: Partial<
  Record<Locale, Record<string, string>>
> = {
  fr: {
    "Konkrete Kundenanfragen": "Demandes clients concrètes",
  ...
  sq: {
    "Konkrete Kundenanfragen": "Kërkesa konkrete nga klientët",
    "Eigene Regionen auswählen": "Zgjidh rajonet e tua",
    "Passende Leistungen festlegen": "Zgjidh shërbimet e përshtatshme",
    "Keine klassische Kaltakquise": "Pa telefonata të ftohta klasike",
    "Volle Kostenkontrolle": "Kontroll i plotë i kostove",
    "Schneller Zugang zu neuen Aufträgen": "Qasje e shpejtë në punë të reja",
  },

  tr: {
    "Konkrete Kundenanfragen": "Gerçek müşteri talepleri",
    "Eigene Regionen auswählen": "Kendi bölgelerini seç",
    "Passende Leistungen festlegen": "Uygun hizmetleri belirle",
    "Keine klassische Kaltakquise": "Klasik soğuk arama yok",
    "Volle Kostenkontrolle": "Tam maliyet kontrolü",
    "Schneller Zugang zu neuen Aufträgen": "Yeni işlere hızlı erişim",
  },

  pt: {
    "Konkrete Kundenanfragen": "Pedidos concretos de clientes",
    "Eigene Regionen auswählen": "Escolher as suas regiões",
    "Passende Leistungen festlegen": "Definir os serviços adequados",
    "Keine klassische Kaltakquise": "Sem chamadas comerciais a frio",
    "Volle Kostenkontrolle": "Controlo total dos custos",
    "Schneller Zugang zu neuen Aufträgen": "Acesso rápido a novos pedidos",
  },

  es: {
    "Konkrete Kundenanfragen": "Solicitudes concretas de clientes",
    "Eigene Regionen auswählen": "Elige tus regiones",
    "Passende Leistungen festlegen": "Define los servicios adecuados",
    "Keine klassische Kaltakquise": "Sin llamadas comerciales en frío",
    "Volle Kostenkontrolle": "Control total de costes",
    "Schneller Zugang zu neuen Aufträgen": "Acceso rápido a nuevos trabajos",
  },
};
...
export function translateHomeText(
  ...
  const providerAdvantage =
    providerAdvantageTranslations[locale]?.[value];

  if (providerAdvantage) {
    return providerAdvantage;
  }

  const finalTranslation =
    finalHomepageTranslations[locale]?.[value];
