...
import { updateSeoCity } from "../../actions";
...
export default async function EditSeoCityPage({
  params,
}: PageProps) {
  ...
  const updateAction = updateSeoCity.bind(null, city.id);
    ...
    <main className="city-editor-page">
      <div className="city-editor-shell">
        <header>
          ...
          <span>SEO Stadt bearbeiten</span>
          <h1>{city.name}</h1>

          <p>
            Inhalte, Status, Google-Metadaten und regionale Informationen
            bearbeiten.
          </p>
        </header>
        ...
        <CityForm
          ...
          city={{
            ...
            neighboringCities: city.neighboringCities,
            status: city.status,
