        ...
        <section className="card p-5 sm:p-6 lg:p-7">
          <div className="max-w-4xl min-w-0">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-white/45 sm:text-base sm:leading-7">
              Genau das ist der Kern von Auftrago: kein blindes Werbemodell,
              sondern ein klarer Lead-Marktplatz. Du prüfst Anfragen zuerst,
              investierst nur bei echtem Interesse und reagierst dann direkt auf
        ...
        <section className="card p-5 sm:p-6">
          ...
          <div className="mt-4 space-y-3 text-sm leading-7 text-white/62 sm:text-base sm:leading-8">
            <p>
              ...
              deinem Angebot passen. Gute Leads erkennst du daran, dass der
              Bedarf klar beschrieben ist und du fachlich sowie regional sauber
              liefern kannst.
            </p>
            <p>
          ...
          {leads.length === 0 ? (
            <div className="card p-6 sm:p-8">
              ...
              <p className="mt-2 max-w-2xl text-sm leading-7 text-white/60 sm:text-base">
                Sobald neue Kundenanfragen eingehen, erscheinen sie hier in
                deiner Übersicht. Dann kannst du prüfen, welche Kontakte für dein
            ...
            leads.map((lead) => {
              ...
              return (
                <article key={lead.id} className="card p-4 sm:p-5 md:p-6">
                  <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_280px]">
                          ...
                          {!isUnlocked ? (
                            <div className="flex flex-col gap-2">
                              ...
                              <div className="text-sm leading-7 text-white/60 sm:text-base">
                                ...
                                . Nach der Freischaltung siehst du Name, Telefon
                                und E-Mail des Kunden und kannst direkt Kontakt
                                aufnehmen.
                              </div>

                              <div className="mt-2 text-sm leading-7 text-white/45">
                                Tipp: Nutze Credits besonders gezielt bei Leads,
                                die fachlich und regional gut zu deinem
                                Unternehmen passen.
                              </div>
                            </div>
                          ) : (
                            <div>
                              ...
                              <div className="mt-4 text-sm leading-7 text-white/45">
                                Jetzt kannst du den Kunden direkt kontaktieren
                                und dein Angebot abgeben oder offene Fragen
                                klären.
                              </div>
                            </div>
                          )}
                    ...
                    <div className="min-w-0 xl:w-[280px]">
                      <div className="flex h-full flex-col gap-3 xl:items-stretch">
                        ...
                        {!isUnlocked ? (
                          <p className="text-sm leading-6 text-white/45">
                            Nur freischalten, wenn der Lead wirklich zu deinem
                            Angebot, deiner Region und deiner Auslastung passt.
                          </p>
                        ) : (
                          <p className="text-sm leading-6 text-emerald-200/80">
                            Dieser Lead ist bereits freigeschaltet und kann
