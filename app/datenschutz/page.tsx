export const metadata = {
  title: "Datenschutz | Auftrago",
  description:
    "Datenschutzerklärung von Auftrago.ch zur Bearbeitung personenbezogener Daten.",
};
      ...
      <section className="premium-section">
        <div className="container" style={{ maxWidth: "980px" }}>
          <div className="premium-provider-card">
            ...
            <p>
              Diese Datenschutzerklärung informiert darüber, wie Auftrago.ch
              personenbezogene Daten bearbeitet, wenn Sie unsere Website,
              Formulare, Anbieterbereiche oder Dienstleistungen nutzen.
            </p>
            ...
            <p>
              Wir bearbeiten insbesondere Daten, die Sie uns über Formulare,
              Registrierungen oder Kontaktanfragen übermitteln. Dazu können
              gehören:
            </p>
            ...
            <ul>
              ...
              <li>Telefonnummer</li>
              <li>Adresse, PLZ, Ort und Region</li>
            ...
            <ul>
              <li>Bearbeitung von Offerten- und Kundenanfragen</li>
              <li>Vermittlung von Anfragen an passende Anbieter</li>
            ...
            <p>
              Kundendaten können an registrierte Anbieter weitergegeben werden,
              soweit dies für die Bearbeitung einer Anfrage oder die Vermittlung
              einer Offerte erforderlich ist. Kontaktdaten von Kunden werden
              Anbietern erst freigeschaltet, wenn ein Lead entsprechend gekauft
              oder freigegeben wurde.
            </p>

            <p>
              Ausserdem können Daten an technische Dienstleister weitergegeben
              werden, die uns beim Betrieb der Website, beim Hosting, beim
              E-Mail-Versand, bei Zahlungen oder bei der Datenverarbeitung
              unterstützen.
            </p>
            ...
            <p>
              Für Zahlungen und Credit-Käufe nutzen wir Zahlungsdienstleister
              wie Stripe. Bei einer Zahlung werden die für die Abwicklung
              notwendigen Zahlungs- und Transaktionsdaten an den jeweiligen
              Zahlungsdienstleister übermittelt. Auftrago speichert keine
            ...
            <p>
              ...
              um personenbezogene Daten vor Verlust, Missbrauch, unbefugtem
