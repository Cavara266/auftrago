...
const stats = [["3", "Heute"], ["11", "Diese Woche"], ["4", "Mitarbeiter"], ["2", "Wiederkehrend"]];
const items = [["08:00", "Umzugsreinigung", "Zürich", "Team 1"], ["13:30", "Hauswartung", "Baden", "Team 2"], ["17:00", "Abnahme", "Aarau", "Dejan"]];
        ...
        <div style={{
          ...
          <div>
            <div style={{color:"#67e8f9",fontSize:12,fontWeight:900}}>
              AUFTRAGO BUSINESS / EINSATZPLANUNG
            </div>
            <h1 style={{fontSize:44,margin:"8px 0"}}>Kalender</h1>
            <p style={{color:"#91a0b7",fontSize:16,maxWidth:720}}>
              Termine, Teams und wiederkehrende Einsätze übersichtlich planen.
            </p>
          </div>
