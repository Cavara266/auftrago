...
const stats = [["7", "Aktive Aufträge"], ["3", "Heute"], ["12", "Diesen Monat"], ["CHF 21'800.–", "Auftragswert"]];
const items = [["AUF-1048", "Umzugsreinigung Zürich", "08:00", "Heute"], ["AUF-1047", "Hauswartung Baden", "13:30", "Geplant"], ["AUF-1046", "Fensterreinigung Aarau", "17:00", "Geplant"]];
        ...
        <div style={{
          ...
          <div>
            <div style={{color:"#67e8f9",fontSize:12,fontWeight:900}}>
              AUFTRAGO BUSINESS / AUFTRAGSMANAGEMENT
            </div>
            <h1 style={{fontSize:44,margin:"8px 0"}}>Aufträge</h1>
            <p style={{color:"#91a0b7",fontSize:16,maxWidth:720}}>
              Alle laufenden und kommenden Arbeiten zentral steuern.
            </p>
          </div>
