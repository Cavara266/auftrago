...
const stats = [["26.5 h", "Diese Woche"], ["6.8 h", "Heute"], ["4", "Mitarbeiter"], ["CHF 2'180.–", "Arbeitswert"]];
const items = [["Heute", "Mitarbeiter 1", "Umzugsreinigung", "04:15 h"], ["Heute", "Mitarbeiter 2", "Hauswartung", "02:35 h"], ["Gestern", "Mitarbeiter 3", "Fensterreinigung", "06:40 h"]];
        ...
        <div style={{
          ...
          <div>
            <div style={{color:"#67e8f9",fontSize:12,fontWeight:900}}>
              AUFTRAGO BUSINESS / ZEITERFASSUNG
            </div>
            <h1 style={{fontSize:44,margin:"8px 0"}}>Arbeitszeiten</h1>
            <p style={{color:"#91a0b7",fontSize:16,maxWidth:720}}>
              Arbeitszeiten direkt pro Mitarbeiter und Auftrag erfassen.
            </p>
          </div>
