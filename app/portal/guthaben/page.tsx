...
const creditPackages = [
  {
    ...
    credits: 20,
    price: "CHF 29",
    pricePerCredit: "CHF 1.45",
    badge: "Zum Starten",
    description:
      "Ideal für erste Freischaltungen und den Einstieg bei Auftrago.",
    highlight: false,
    benefits: [
  ...
  },
  {
    ...
    credits: 50,
    price: "CHF 69",
    pricePerCredit: "CHF 1.38",
    badge: "Beliebteste Wahl",
    description:
      "Für aktive Anbieter, die regelmässig neue Kundenkontakte sichern.",
    highlight: true,
    benefits: [
  ...
  },
  {
    ...
    credits: 100,
    price: "CHF 129",
    pricePerCredit: "CHF 1.29",
    badge: "Für regelmässige Käufe",
    description:
      "Für Unternehmen mit regelmässigem Leadbedarf und mehreren Regionen.",
    highlight: false,
    benefits: [
      "100 Credits sofort verfügbar",
      "Attraktiver Preis pro Credit",
  ...
  },
  {
    ...
    credits: 250,
    price: "CHF 249",
    pricePerCredit: "CHF 1.00",
    badge: "Starker Preisvorteil",
    description:
      "Für Firmen, die laufend neue Kundenanfragen freischalten möchten.",
    highlight: false,
    benefits: [
      "250 Credits sofort verfügbar",
      "Nur CHF 1.00 pro Credit",
      "Ideal für mehrere Einsatzgebiete",
    ],
  },
  {
    id: "premium",
    ...
    credits: 600,
    price: "CHF 529",
    pricePerCredit: "CHF 0.88",
    badge: "Für starke Anbieter",
    description:
      "Für sehr aktive Unternehmen mit hohem und regelmässigem Leadbedarf.",
    highlight: false,
    benefits: [
      "600 Credits sofort verfügbar",
      "Nur CHF 0.88 pro Credit",
      "Deutlicher Mengenrabatt",
    ],
  },
  {
    id: "enterprise",
    ...
    credits: 1200,
    price: "CHF 999",
    pricePerCredit: "CHF 0.83",
    badge: "Maximaler Vorteil",
    description:
      "Das grösste Paket für Firmen, die dauerhaft viele Aufträge sichern.",
    highlight: false,
    benefits: [
      "1’200 Credits sofort verfügbar",
      "Günstigster Preis pro Credit",
