                ...
                >
                  <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-center">
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <Link
                    href={`/arbeit-suchen/konto/bewerbungen/${application.id}`}
                    className="inline-flex min-h-[46px] items-center justify-center rounded-xl border border-sky-400/15 bg-sky-400/[0.06] px-5 text-sm font-black text-sky-300 transition hover:border-sky-400/30 hover:bg-sky-400/[0.10]"
                  >
                    Details
                  </Link>
                    </div>
